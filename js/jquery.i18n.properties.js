(function($) {
    ...
    $.i18n.prop = function(e) {
        ...
        if (t == null) return "[" + e + "]";
        var n;
        if (arguments.length == 2 && $.isArray(arguments[1])) n = arguments[1];
        var r;
        if (typeof t == "string") {
            r = 0;
            while ((r = t.indexOf("\\", r)) != -1) {
                if (t.charAt(r + 1) == "t") t = t.substring(0, r) + "	" + t.substring(r++ +2);
                else if (t.charAt(r + 1) == "r") t = t.substring(0, r) + "\r" + t.substring(r++ +2);
                else if (t.charAt(r + 1) == "n") t = t.substring(0, r) + "\n" + t.substring(r++ +2);
                else if (t.charAt(r + 1) == "f") t = t.substring(0, r) + "\f" + t.substring(r++ +2);
                else if (t.charAt(r + 1) == "\\") t = t.substring(0, r) + "\\" + t.substring(r++ +2);
                else t = t.substring(0, r) + t.substring(r + 1)
            }
            var i = [],
                s, o;
            r = 0;
            while (r < t.length) {
                if (t.charAt(r) == "'") {
                    if (r == t.length - 1) t = t.substring(0, r);
                    else if (t.charAt(r + 1) == "'") t = t.substring(0, r) + t.substring(++r);
                    else {
                        s = r + 2;
        ...
        if (t.lengh == 1 && typeof t[0] == "string") return t[0];
        var u = "";
        for (r = 0; r < t.length; r++) {
            if (typeof t[r] == "string") u += t[r];
            else if (n && t[r] < n.length) u += n[t[r]];
            else if (!n && t[r] + 1 < arguments.length) u += arguments[t[r] + 1];
            else u += "{" + t[r] + "}"
        }
        return u
    };
    ...
    if (!cbSplit) {
        cbSplit = function(e, t, n) {
            if (Object.prototype.toString.call(t) !== "[object RegExp]") {
                if (typeof cbSplit._nativeSplit == "undefined") return e.split(t, n);
                else return cbSplit._nativeSplit.call(e, t, n)
            }
            var r = [],
                i = 0,
                s = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.sticky ? "y" : ""),
                t = RegExp(t.source, s + "g"),
                o, u, a, f;
            e = e + "";
