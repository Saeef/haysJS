    ...
    var Hays01 = {
        ...
        mainCss: function(applyCss) {
            if (applyCss) {
                ...
                style.innerHTML += ".hays-jobs .job-search-title {margin-bottom:20px; display:inline-block;}\n";
                ...
                style.innerHTML += ".hays-jobs .result-list .result { padding:0; padding-bottom:5px !important; margin:20px auto !important; border:1px solid #e6e6e6; padding-bottom:0; padding-top:20px; background-color:#ffffff;}";
                ...
                style.innerHTML += ".hays-jobs a.butdetails {position: absolute;right: 4%;bottom: 18%;padding: 10px 23px; text-decoration: none !important;}";
